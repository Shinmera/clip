...
* `C:CASE` <br />
  Takes a `VALUE` attribute that each element in the body is compared against, just like CL's `case`. Each element in the body may have multiple `VALUE` attributes, too.
* `C:S` <br />
